...
describe('EndpointResponse', () => {
    it('should be able to accept', () => {
        ...
        const response = new EndpointResponse(handler);
        response.accept();
    ...
    it('should be able to reject', () => {
        ...
        const response = new EndpointResponse(handler);
        response.reject();
        expect(handler).toBeCalledWith({}, {error: {message: 'Message rejected', code: 403}});
    });
    ...
    it('should be able to send', () => {
        ...
        expect(handler).toBeCalledWith({}, {message: {event: 'test', payload: {test: 'test'}}});
    });
