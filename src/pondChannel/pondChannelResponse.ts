...
export class PondChannelResponse extends PondResponse {
     ...
     */
    public accept(assigns?: PondAssigns): PondChannelResponse {
        this._hasExecuted = true;
        assigns = Object.assign({}, assigns, this._user.assigns);
     ...
     */
    public reject(message?: string, errorCode?: number): PondChannelResponse {
        this._hasExecuted = true;
        ...
        this._user.socket.send(JSON.stringify({
            event: 'POND_ERROR',
            payload: {message: text, code: errorCode || 403},
     ...
     */
    public trackPresence(presence: PondPresence): PondChannelResponse {
